...
4. `assets/store/screenshots/04-dashboard-favorites.png`
5. `assets/store/screenshots/07-dark-mode-support.png`

Keep `assets/store/screenshots/05-dashboard-settings.png` and `assets/store/screenshots/06-dashboard-diagnostics.png` for GitHub and internal documentation. The listing description covers settings, while favorites and dark-mode support are stronger storefront images.
